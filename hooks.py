...
def update(oBugRegex=None, bRequireBugNumber=True, asAllowedStatuses=None, sSeparator=None, sBZUrl=None, sBZUser=None, sBZPasswd=None, logger=None, bz_init=None, sRefPrefix=None):
  """
